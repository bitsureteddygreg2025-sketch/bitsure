...
TEXTS = {
    "fr": {
        ...
        "help_full": (
            ...
            "/analyse SYMBOLE – Analyse technique complète (aucun trade sans confirmation)\n"
            ...
            "🤖 *AutoTrade Binance*\n"
            "/autotrade – Ouvrir le menu AutoTrade Binance\n"
            "/setsecurity CODE – Créer/modifier le code sécurité (format 4827BZ)\n"
            "/setapikeys CLE SECRET CODE – Configurer vos clés API Binance\n"
            "/config – Voir la configuration d'AutoTrade\n"
            "/positions – Voir vos positions ouvertes\n"
            "/close ID CODE – Fermer une position\n"
            ...
            "/setleverage LEVIER CODE – Configurer le levier (1-125)\n"
            "/setrisk % CODE – Configurer le risque par trade (%)\n"
            "/whitelist SYMBOLE – Ajouter un symbole autorisé\n"
            "/blacklist SYMBOLE – Exclure un symbole\n"
            "/emergency_stop CODE – Arrêt d'urgence et fermeture de toutes les positions\n"
            "/confirmmanual TOKEN CODE – Confirmer un trade proposé par /analyse\n\n"
    ...
    "en": {
        ...
        "help_full": (
            ...
            "/help – Command list\n"
            "/analyse SYMBOL – Full technical analysis (no trade without confirmation)\n"
            ...
            "🤖 *AutoTrade Binance*\n"
            "/autotrade – Open the Binance AutoTrade menu\n"
            "/setsecurity CODE – Create/change the security code (format 4827BZ)\n"
            "/setapikeys KEY SECRET CODE – Configure Binance API keys\n"
            "/config – View AutoTrade configuration\n"
            "/positions – View open positions\n"
            "/close ID CODE – Close a position\n"
            "/pnl – Account PnL statistics\n"
            "/account – Full Binance account dashboard\n"
            "/history_trades – Last 10 Binance trades history\n"
            "/setleverage LEVERAGE CODE – Set leverage (1-125)\n"
            "/setrisk % CODE – Set risk per trade (%)\n"
            "/whitelist SYMBOL – Add whitelisted symbol\n"
            "/blacklist SYMBOL – Blacklist a symbol\n"
            "/emergency_stop CODE – Emergency stop & close all positions\n"
            "/confirmmanual TOKEN CODE – Confirm a trade proposed by /analyse\n\n"
